    ...
    if (subcommand) {
      ...
      switch (targetCommand) {
        ...
        case 'init':
          ...
          func = (await import('./commands/init/index.js')).default;
          break;
        case 'login':
          telemetry.trackCliCommandLogin(userSuppliedSubCommand);
          func = (c: Client) =>
            import('./commands/login/index.js').then(m =>
              m.default(c, { shouldParseArgs: true })
            );
          break;
        ...
        case 'build':
          ...
          func = (await import('./commands-bulk.js')).build;
          break;
        case 'cache':
        ...
        case 'link':
          ...
          func = (await import('./commands-bulk.js')).link;
          break;
        case 'list':
          telemetry.trackCliCommandList(userSuppliedSubCommand);
          func = (await import('./commands-bulk.js')).list;
          break;
        case 'logs':
